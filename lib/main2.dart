...
import 'package:capture_input_ouput/test_utils.dart';
import 'package:capture_input_ouput/textInput.dart';
import 'package:capture_input_ouput/text_painter_button.dart';
import 'package:capture_input_ouput/utils/cutils2.dart';
import 'package:capture_input_ouput/utils/msadpcrn.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> stop() async {
    ...
    print(inputFileStream?.audioCache!.length);
    print(outputFileStream?.audioCache?.length);
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text("Version: 1.0.3(2024-12-17)")
          ],
        ),
      ),
    );
